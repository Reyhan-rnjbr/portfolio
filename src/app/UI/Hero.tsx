...
const Hero = () => {
  return (
    ...
    lg:left-[300px] "
          ...
          <button className="flex md:hidden md:group-hover:flex bg-gray-700 text-white pl-[4.8px] pr-[12.81px] py-[3.2px] rounded-full">
            <img src="/avatar.jpg" alt="" className="w-[25.62px] h-[25.62px] rounded-full"/>
            <p className="text-[19px] font-medium">Reyhane</p>
          </button>
          <svg
            className=""
            width="76"
        ...
        <div className="flex items-center" style={{ width: '100%', padding: 0 }}>
          <img src="/portfolio2.jpg" alt="" className="rounded-full h-[550px] w-[200px] pt-[20px]" style={{ width: '500px', margin: 'auto' }} />
        </div>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-3 px-4 mt-6">
  <button className="rounded-full px-4 py-1 bg-gray-100 border border-gray-300 text-sm sm:text-base">
    <p className="text-gray-700 font-medium">Front-End</p>
  </button>

  <button className="rounded-full px-4 py-1 bg-gray-100 border border-gray-300 text-sm sm:text-base">
    <p className="text-gray-700 font-medium">React Developer</p>
  </button>
  ...
  <button className="rounded-full px-4 py-1 bg-gray-100 border border-gray-300 text-sm sm:text-base">
    <p className="text-gray-700 font-medium">Web Design</p>
      ...
      <div className=" header-bg flex flex-col items-center justify-center text-center px-4 mt-12">
        <p className="font-bold text-[32px] sm:text-[44px] lg:text-[59px]">
          <span className=" text-gray-700 text-[59px] font-bold">Reyhane </span>
          Ranjbar
        </p>
          <p className="text-gray-700 font-medium text-sm sm:text-base lg:text-[18px] mt-4 max-w-2xl">
