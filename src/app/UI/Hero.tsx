    ...
    <>
      <div className=" flex  ">
        <div className="relative flex items-center">
          <div className="flex flex-row items-center rounded-full bg-gray-700 py-[3.2px] pl-[4.8px] pr-[12.81px] text-white ">
            <img
              src="/avatar.jpg"
              alt=""
              className="w-[25.62px] h-[25.62px] rounded-full"
            />
            <p className="font-medium">Your Na..</p>
          </div>

          <div className="absolute left-full top-50 -translate-x-1/5  ">
            <svg
            ...
            >
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M25.1951 20.1859L16.8973 4.28923L14.8089 10.5611L14.6849 10.8771L7.53097 14.5965L25.1951 20.1859Z"
                fill="#344054"
              />
            </svg>
            <svg
        ...
        <div className="flex items-center">
          <img src="/portfolio.jpg" alt="" className="mx-[455.15px]" />
        </div>
        <div className="relative inline-flex w-fit h-fit">
          <svg
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M11.9748 31.6228L0 8.68172L25.3201 16.644L15.2167 21.9177L15.0928 22.2084L11.9748 31.6228Z"
              fill="white"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.15515 11.2311L11.5375 27.2899L13.6472 20.954L13.7725 20.6348L20.9994 16.8775L3.15515 11.2311Z"
              fill="#344054"
            />
          </svg>
        </div>
        <button className="flex leading-none relative z-20 flex-row items-center rounded-full bg-gray-700 text-white py-[3.23px] pl-[4.85px] pr-[12.94px] mr-[140px]">
          <img
            src="/avatar.jpg"
            alt=""
            className="w-[25.88px] h-[25.88px] rounded-full"
          />
          <span className="font-medium">Your Na..</span>
        </button>
      </div>
